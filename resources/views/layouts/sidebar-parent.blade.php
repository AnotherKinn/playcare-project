...
<nav id="sidebarParent" class="d-none d-md-flex flex-column flex-shrink-0 p-3 bg-white border-end shadow-sm position-fixed"
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasSidebar">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title fw-bold text-primary">👨‍👩‍👧 PlayCare</h5>
    ...
    <div class="offcanvas-body p-0">
        <ul class="nav nav-pills flex-column mb-auto px-3">
            ...
            <li><a href="{{ route('parent.data-children.index') }}" class="nav-link text-dark"><i class="bi bi-people me-2"></i> Data Anak</a></li>
            <li><a href="{{ route('parent.booking.index') }}" class="nav-link text-dark"><i class="bi bi-calendar-check me-2"></i> Booking</a></li>
            <li><a href="{{ route('parent.transaction.index') }}" class="nav-link text-dark"><i class="bi bi-wallet2 me-2"></i> Transaksi</a></li>
            <li><a href="{{ route('parent.review.index') }}" class="nav-link text-dark"><i class="bi bi-star me-2"></i> Review</a></li>
            <li><a href="{{ route('parent.profile.index') }}" class="nav-link text-dark"><i class="bi bi-person-circle me-2"></i> Profil</a></li>
        </ul>
        <hr class="mt-3 mb-2">
